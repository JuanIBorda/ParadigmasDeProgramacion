...
const aereo = new EspecieAnimal(formaLocomocion = vuela, pesoReferencia = 50, coeficiente = 3)
const sedentario = new EspecieAnimal(formaLocomocion = inmovil, pesoReferencia = 400, coeficiente = 4)

const delfin = new Animal(peso = 10, especie = acuatico)
const cebra = new Animal(peso = 30, especie = cebraloide)
const puma = new Animal(peso = 500, especie = cebraloide)
const liebre = new Animal(peso = 5, especie = cebraloide)
const gaviota = new Animal(peso = 250, especie = aereo)
const medusa = new Animal(peso = 50, especie = sedentario)
...
const rosa = new Planta(altura = 15, especie = girasolus)
